...
function easypanel_ConfigOptions() {
    ...
    $configarray = array(
		 ...
		 "模块"			=> array( "Type" => "dropdown", "Options" => "php"),					//2	
		 ...
		 "产品名称"			=> array("Type" => "text",'Size'=>'12'),							//18
	);
	return $configarray;
}
...
function easypanel_update_account($params,$edit)
{
	...
	$whmCall->addParam('module',$params["configoption2"]);
	...
	$whmCall->addParam('product_name',$params["configoption18"]);
